...
namespace PCLExt.FileStorage.Folders
{
    ...
    public class PicturesRootFolder : BaseFolder
    {
        ...
        private static IFolder GetPicturesFolder()
        {
            ...
            return new DefaultFolderImplementation(System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyPictures)).CreateFolder("Cache", CreationCollisionOption.OpenIfExists);
#elif WINDOWS_UWP
            return null;
#endif
        }
