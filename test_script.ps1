if($isWindows)
{
	...
	dotnet test test/PCLExt.FileStorage.Core.Test/PCLExt.FileStorage.Core.Test.csproj /p:CollectCoverage=true /p:CoverletOutputFormat=opencover /p:Exclude="[NUnit*]*,[PCLExt.FileStorage.NetFX.Test]*" --logger:"trx;LogFileName=../core-result.trx"
